...
| [versions/](versions/) | 版本面：演进时间线（`manifest.json`）+ 收敛归档（`archive/`） |
| [gotchas/](gotchas/) | 错误面：踩坑记录（时间线，不可变追加） |
| [evolutions/](evolutions/) | 行为面：规则/参数/流程演进补丁（有序加载，可收敛） |
...
| 优先级 | 层级 | 示例 |
|--------|------|------|
| P0 | 树状自说明 | README.md、TASK-TOOLS-INDEX.md、EXEC-CHEATSHEET.md |
