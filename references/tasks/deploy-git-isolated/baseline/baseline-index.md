...
| [baseline-naming-intent.md](baseline-naming-intent.md) | 文件命名与主体意图表达：文件名、docstring、README.md、index.json 如何协同承载意图，提高搜索命中率 | 新建/重命名文件、编写 docstring、维护索引时 |
...
| 19 | **文件名必须承载主体意图**：文件名、docstring、README.md、index.json 四大载体语义一致，协同提高搜索命中率 | [baseline-naming-intent.md](baseline-naming-intent.md) §1-5 |
...
| 版本 | 日期 | 变更 |
|------|------|------|
| v2.7.0 | 2026-08-03 | 新增 `baseline-naming-intent.md`：文件命名与主体意图表达规范——文件名、docstring、README.md、index.json 四大载体协同承载意图，提高搜索工具命中率；顶层原则速查后续追加第 19 条 |
